			...
			<asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" RepeatColumns="3" RepeatLayout="Flow" >
				<ItemTemplate>
					<div class="col-md-4 img-portfolio">
						<asp:ImageButton ID="ImageButton1" runat="server" OnClick="ImageButton1_Click" class="img-responsive img-hover" ImageUrl='<%# Bind("image") %>' AlternateText='<%# Bind("TypeName") %>' />
						<h3>
